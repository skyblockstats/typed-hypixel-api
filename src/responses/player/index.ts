	...
	player: {
		...
		stats: {
			...
			MurderMystery?: {
				...
				deaths_headquarters_MURDER_INFECTION: number
				...
				games_MURDER_WILD_REVOLVERS: number
				coins_pickedup_mountain: number
				kills_mountain: number
				kills_mountain_MURDER_WILD_REVOLVERS: number
				coins_pickedup_mountain_MURDER_WILD_REVOLVERS: number
				games_mountain: number
				coins_pickedup_MURDER_WILD_REVOLVERS: number
				kills_MURDER_WILD_REVOLVERS: number
				games_mountain_MURDER_WILD_REVOLVERS: number
				...
				longest_time_as_survivor_seconds_hypixel_world: number
				longest_time_as_survivor_seconds_hypixel_world_MURDER_INFECTION: number
